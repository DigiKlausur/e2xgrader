define([
  ...
  function is_extra_cell(cell) {
    return (
      ...
      cell.metadata.hasOwnProperty("extended_cell")
    );
  }
  ...
  function patch_MarkdownCell_render() {
    ...
    let extra_cell_types = {
      singlechoice: choice_cell.SinglechoiceCell,
      multiplechoice: choice_cell.MultiplechoiceCell,
      attachments: attachment_cell.AttachmentCell,
      pdf: pdf_cell.PDFCell,
      diagram: diagram_cell.DiagramCell,
    };

    MarkdownCell.prototype.render = function () {
      let type = cell_type(this);
      if (extra_cell_types.hasOwnProperty(type)) {
        let extra_cell = new extra_cell_types[type](this);
        extra_cell.edit_mode = edit_mode;
        extra_cell.render();
      } else {
