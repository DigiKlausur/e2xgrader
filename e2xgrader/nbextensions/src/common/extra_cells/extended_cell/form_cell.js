define([
    ...
    class FormCell extends ExtendedCell {
        ...
        connect_form_elements = function(elements) {
            let that = this;
        ...
        sanitize_choices = function (elements) {
