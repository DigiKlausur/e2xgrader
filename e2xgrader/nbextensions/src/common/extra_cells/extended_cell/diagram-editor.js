define(['jquery'], function($) {
     ...
     */
    function DiagramEditor(config, ui, done, initialized, urlParams, cell)
    {
     ...
     */
    DiagramEditor.editElement = function(cell, elt, config, ui, done, urlParams)
    {
      if (!elt.diagramEditorStarting)
      {
        ...
        }, urlParams, cell).editElement(elt);
       }
    };
     ...
     */
    DiagramEditor.prototype.frameStyle = 'position:absolute;bottom:0;border:0;width:100%;height:100%;';
    ...
    DiagramEditor.prototype.postMessage = function(msg)
    {
        if (this.frame != null)
        {
            this.frame.contentWindow.postMessage(JSON.stringify(msg), 'https://embed.diagrams.net');
        }
    };
    ...
    DiagramEditor.prototype.getFrameStyle = function()
    {
        return this.frameStyle + ';left:' +
            ...
            document.body.scrollTop + $('#header').height() + 'px;';
    };
