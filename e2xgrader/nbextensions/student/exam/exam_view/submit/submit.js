define([
    ...
    class Submit {
        ...
        submit_error_modal(data) {
            ...
            let body = $('<div/>');
            body.append($('<h4/>').text('Something went wrong while submitting the assignment'));
            body.append($('<p/>')
                    .append('Please try to submit via the assignments tab or contact a supervisor.')
            );
