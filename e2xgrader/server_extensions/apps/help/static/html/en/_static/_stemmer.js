...
(function (JSX) {
  ...
  JSX.DEBUG = false;
  var GeneratorFunction$0 = (function () {
    try {
      return Function(
        'import {GeneratorFunction} from "std:iteration"; return GeneratorFunction'
      )();
    } catch (e) {
      return function GeneratorFunction() {};
    }
  })();
  var __jsx_generator_object$0 = (function () {
  ...
  BaseStemmer.copy_from$LBaseStemmer$LBaseStemmer$ =
    BaseStemmer$copy_from$LBaseStemmer$LBaseStemmer$;
  ...
  BaseStemmer.prototype.in_grouping$AIII = function (s, min, max) {
    ...
    ($__jsx_postinc_t = this.cursor),
      (this.cursor = ($__jsx_postinc_t + 1) | 0),
      $__jsx_postinc_t;
    return true;
  };
  ...
  BaseStemmer.in_grouping$LBaseStemmer$AIII =
    BaseStemmer$in_grouping$LBaseStemmer$AIII;
  ...
  BaseStemmer.in_grouping_b$LBaseStemmer$AIII =
    BaseStemmer$in_grouping_b$LBaseStemmer$AIII;
  ...
  BaseStemmer.out_grouping$LBaseStemmer$AIII =
    BaseStemmer$out_grouping$LBaseStemmer$AIII;
  ...
  BaseStemmer.out_grouping_b$LBaseStemmer$AIII =
    BaseStemmer$out_grouping_b$LBaseStemmer$AIII;
  ...
  BaseStemmer.in_range_b$LBaseStemmer$II =
    BaseStemmer$in_range_b$LBaseStemmer$II;
  ...
  BaseStemmer.out_range_b$LBaseStemmer$II =
    BaseStemmer$out_range_b$LBaseStemmer$II;
  ...
  BaseStemmer.prototype.eq_s$IS = function (s_size, s) {
    ...
    if (
      this.current.slice((cursor$0 = this.cursor), (cursor$0 + s_size) | 0) !==
      s
    ) {
      return false;
    }
  ...
  BaseStemmer.prototype.eq_s_b$IS = function (s_size, s) {
    ...
    if (
      this.current.slice(((cursor$0 = this.cursor) - s_size) | 0, cursor$0) !==
      s
    ) {
      return false;
    }
  ...
  BaseStemmer.find_among$LBaseStemmer$ALAmong$I =
    BaseStemmer$find_among$LBaseStemmer$ALAmong$I;
  ...
  BaseStemmer.find_among_b$LBaseStemmer$ALAmong$I =
    BaseStemmer$find_among_b$LBaseStemmer$ALAmong$I;
  ...
  BaseStemmer.replace_s$LBaseStemmer$IIS =
    BaseStemmer$replace_s$LBaseStemmer$IIS;
  ...
  BaseStemmer.prototype.slice_check$ = function () {
    ...
    var ket$0;
    var limit$0;
    return (bra$0 = this.bra) < 0 ||
      bra$0 > (ket$0 = this.ket) ||
      ket$0 > (limit$0 = this.limit) ||
      limit$0 > this.current.length
      ? false
      : true;
  };
  ...
  GermanStemmer.prototype.copy_from =
    GermanStemmer.prototype.copy_from$LGermanStemmer$;
  ...
  GermanStemmer.r_prelude$LGermanStemmer$ =
    GermanStemmer$r_prelude$LGermanStemmer$;
  ...
  GermanStemmer.prototype.r_mark_regions =
    GermanStemmer.prototype.r_mark_regions$;
  ...
  GermanStemmer.prototype.r_postlude$ = function () {
    ...
    replab0: while (true) {
      ...
      lab1: while (lab1 === true) {
        lab1 = false;
        this.bra = this.cursor;
        among_var = BaseStemmer$find_among$LBaseStemmer$ALAmong$I(
          this,
          GermanStemmer.a_0,
          6
        );
  ...
  GermanStemmer.r_postlude$LGermanStemmer$ =
    GermanStemmer$r_postlude$LGermanStemmer$;
  ...
  GermanStemmer.prototype.r_standard_suffix$ = function () {
    ...
    lab0: while (lab0 === true) {
      lab0 = false;
      this.ket = this.cursor;
      among_var = BaseStemmer$find_among_b$LBaseStemmer$ALAmong$I(
        this,
        GermanStemmer.a_1,
        7
      );
  ...
  GermanStemmer.prototype.r_standard_suffix =
    GermanStemmer.prototype.r_standard_suffix$;
  ...
  GermanStemmer.r_standard_suffix$LGermanStemmer$ =
    GermanStemmer$r_standard_suffix$LGermanStemmer$;
  ...
  GermanStemmer.hashCode$LGermanStemmer$ =
    GermanStemmer$hashCode$LGermanStemmer$;
