...
from ...exporters import (
    ...
    GradeSelectedAssignmentExporter,
)
...
class ExportSelectedAssignmentGradesHandler(BaseHandler):
    ...
    def get(self):
        ...
        self.__exporter = GradeSelectedAssignmentExporter(
            self.gradebook, assignment_ids
        )
...
formgrade_handlers = [
    ...
    (
        r"/formgrader/export_grades/selected_assignments/?",
        ExportSelectedAssignmentGradesHandler,
    ),
]
