...
console.log("/formgrader/api/student");
...
var StudentUI = Backbone.View.extend({
    ...
    console.log(this.model.get('id'))
        ...
        this.studentList = createModal("edit-student-modal", "Editing " + this.model.get("id"), body, footer);
...
var createStudentModal = function () {
    ...
    var createStudent = function () {
        ...
        modal.modal('hide');
        setTimeout(function(){ location.reload(); }, 1000); //dirty #TODO find why lagging
