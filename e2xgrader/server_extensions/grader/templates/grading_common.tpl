...
{%- block body -%}
  ...
  <div class="option" id="manualGrading" onclick="window.location='{{ base_url }}/grader/assignments/assignment_common/grading_common/manual_grading/?assignment_id={{ assignment_id }}'">
