...
grader_static_files = []
for (dirname, dirnames, filenames) in os.walk("e2xgrader/server_extensions/grader/static"):
    root = os.path.relpath(dirname, "e2xgrader/server_extensions/grader")
    for filename in filenames:
        grader_static_files.append(os.path.join(root, filename))
for (dirname, dirnames, filenames) in os.walk("e2xgrader/server_extensions/grader/templates"):
    root = os.path.relpath(dirname, "e2xgrader/server_extensions/grader")
    for filename in filenames:
        grader_static_files.append(os.path.join(root, filename))
...
setup_args = dict(
    ...
    package_data={
        ...
        'e2xgrader.server_extensions.grader': grader_static_files,
    },
    install_requires=[
        "jupyter",
        "notebook>=4.2",
